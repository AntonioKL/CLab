assembler: assembler_compiler.o file_proccess.o first_read_manager.o global_functions.o second_read_manager.o
	gcc -Wall -ansi -pedantic assembler_compiler.o file_proccess.o first_read_manager.o global_functions.o second_read_manager.o -o assembler
	rm *.o
